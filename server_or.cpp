...
int main() {
    ...
    //establish UDP socket in server_or
    ...
    printf("The Server OR is up and running using UDP on port 21784.\n");
    ...
    while (1) {
        ...
        string res = orR(to_string(tmpV[1]).c_str(), to_string(tmpV[2]).c_str());
